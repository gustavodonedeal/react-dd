This project was hand-written from the ground up by Gustavo and Ben, not bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
